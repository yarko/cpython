...
class StreamHandler(Handler):
    ...
    def emit(self, record):
        ...
        try:
            ...
            if not _unicode: #if no unicode support...
                stream.write(fs % msg)
            # TODO: yarkot: regardless of unicode support,
            # if the message is or isn't an instance of unicode string,
            #    it needs to be converted to unicode for StreamIO / StringIO
            else:
                ufs = u'%s\n'
                try:
